...
cEmSetList::cEmSetList(const Pair& _pp)
{
...
void cEmSetList::read(const Pair &_pp)
{
    u32 shift = 0;
...
void cEmSetList::print(void) const
{
    printf("\n##### EmSetList file #####\n");
